...
// Change velocity of snake based on key press
...
const initGame = () => {
  ...
  if (snakeX === foodX && snakeY === foodY){
    ...
    score++;
    highScore = score >= highScore ? score : highScore; // If score > highs core => high score = score
  ...
  //shifting forward values of elements in snake bosy by one
...
document.addEventListener("keypress", changeDirectionKB);